...
{{-- NAVBAR --}}
    <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-success shadow" style="z-index: 1030;"> -->
    <nav class="navbar  bg-secondary navbar-expand-lg " data-bs-theme="dark" style="z-index: 1030;">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold fs-4" href="#">Toko Dilla</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
                <span class="navbar-toggler-icon"></span>
            </button>

            <div class="navbar-collapse justify-content-end d-flex" id="navbarNav">
                <ul class="navbar-nav">
                    @auth
                        <li class="nav-item">
                            <a class="nav-link text-white border border-white" href="{{ url('/dashboard') }}">Dashboard</a>
                        </li>  {{--
                        <li class="nav-item">
                            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                @csrf
                                <button type="submit" class="btn btn-link nav-link text-white border border-white" style="text-decoration: none;">Logout</button>
                            </form>
                        </li>  --}}
                    @endauth
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link text-white border border-white" href="{{ route('login') }}">Login</a>
                        </li>
                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav-link text-white border border-white" href="{{ route('register') }}">Register</a>
                            </li>
                        @endif
                    @endguest
                </ul>
...
<div class="min-h-screen flex flex-col items-center justify-center bg-gray-100 px-4 py-10">
    <h1 class="text-3xl font-bold text-gray-800 mb-10">Toko Dilla</h1>

    <!-- Konten Gambar dan Deskripsi -->
    <div class="flex flex-col lg:flex-row items-center justify-center gap-10 max-w-6xl w-full">
        <!-- Gambar Toko -->
        <div class="w-full lg:w-2/2">
            <img src="{{ asset('imgFoto/tokoDila.jpeg') }}" alt="Toko Background" class="rounded-xl shadow-lg w-full h-auto object-cover">
        </div>

        <!-- Card Informasi -->
        <div class="bg-white shadow-xl rounded-xl max-w-lg w-full p-6 md:p-8 text-justify">
         ...
         <!-- Visi -->
            <div class="mt-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-2 border-b pb-1">Visi</h3>
                <p class="text-sm text-gray-700 leading-relaxed text-justify italic">
                    Mewujudkan kedisiplinan dan tanggung jawab kerja melalui sistem absensi yang jujur, teratur, dan mendukung pelayanan di Toko Dilla.
                </p>
            </div>

            <!-- Misi -->
            <div class="mt-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-2 border-b pb-1">Misi</h3>
                <ul class="list-decimal pl-6 text-sm text-gray-700 leading-relaxed text-justify space-y-2">
                    <li>Menerapkan absensi harian yang tertib dan efisien.</li>
                    <li>Menumbuhkan disiplin waktu di kalangan karyawan.</li>
                    <li>Menggunakan absensi sebagai dasar evaluasi kerja.</li>
                    <li>Menjaga keadilan dan tanggung jawab dalam kehadiran.</li>
                    <li>Mendukung kelancaran operasional lewat kehadiran tepat waktu.</li>
                </ul>
            </div>
        ...
        <!-- Bootstrap 5 JS (wajib untuk navbar toggle bekerja) -->
